  ...
  <div className="home">
    <main className="home_main">
      ...
      <div className="app_box-text">
        ...
        and my <a className="home_link" href="https://drive.google.com/file/d/10mxNyPX6HA4w7eIn44vSgp3jg7gHP8kA/view">final performance</a> at the School for Poetic Computation. And here's my <a className="home_link" href="/rss.xml">RSS</a> feed!
      </div>
